...
export const QUICK_ACTIONS = [
  ...
  { id: 'complaint', label: '📝 تقديم شكوى / اقتراح / استفسار' },
]
...
export const FLOWS = {
  ...
  complaint: async () => ({
    text: 'يهمنا نسمع منك 🙏\nادخل على صفحة الشكاوى واكتب بياناتك (الاسم ورقم الموبايل) وتفاصيل شكواك أو اقتراحك أو استفسارك، وفريق خدمة العملاء هيتواصل معاك.',
    link: { to: '/complaints', label: 'اذهب لصفحة الشكاوى والاقتراحات' },
  }),
}
