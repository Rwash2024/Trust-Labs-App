...
export default function InternationalAbout() {
  ...
  return (
    <div dir="ltr" lang="en">
      ...
      <section className="about__section">
        <h2 className="about__section-title">Our Specialist Team</h2>
        <p className="about__story">
          Our team of consultants and specialists ensures every test is performed with precision, care, and scientific excellence.
        </p>
      ...
      <section className="about__section">
        <h2 className="about__section-title">Accreditations &amp; Certifications</h2>
        <p className="about__story about__story--tight">
          In pursuit of excellence, Trust Labs holds accredited quality certifications from the following international bodies
        </p>
        <div className="about__accreditations">
          {accreditations.map((item, i) => (
            <div className="about__accreditation" key={item.name} style={{ animationDelay: `${i * 70}ms` }}>
