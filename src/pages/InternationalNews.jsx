...
export default function InternationalNews() {
  ...
  return (
    <div className="news" dir="ltr" lang="en">
      <section className="news__hero">
        ...
        <h1 className="news__title">Lab News</h1>
        <p className="news__subtitle">The latest Trust Labs news and announcements</p>
        <p className="news__subtitle" style={{ opacity: 0.75, fontSize: '12px', marginTop: '4px' }}>
          Some articles below are only available in Arabic for now.
        </p>
      </section>
